<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <a class="navbar-brand brand-logo-mini" href="<?php echo e(route('Dashboard')); ?>"><img src="<?php echo e(asset('assets/images/favicon-32x32.png')); ?>"
                alt="logo" /></a>
    </div>
...
<?php /**PATH C:\Users\Gean\Projetos\contacts\resources\views/user/layout/partials/_navbar.blade.php ENDPATH**/ ?>